...
Cesium.Ion.defaultAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiI4NThiYmNmNC1jMjVmLTQ0NjktOWZhYS0xMDIyMWExMDU4YzEiLCJpZCI6MTc5NjY4LCJpYXQiOjE3MDQ2MTkxNzR9.iSGSUSbdNEovodgdqFHjEaepHdCX6t-TPcFYJ4KQ-Pc';
const Home: React.FC = () => {
    ...
    return (
        <>
            <div>
                <div style={{position:"fixed",top:"20px",right:"20px",zIndex:"20"}}>
                    <button onClick={flyTo}>点我</button>
                </div>
